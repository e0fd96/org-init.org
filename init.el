...
;;  '(org-block ((t (:extend t :background "white smoke"))))
;;  '(org-block-begin-line ((t (:underline t))))
;;  '(org-block-end-line ((t (:background "white smoke"))))
...
(custom-set-variables
 ...
 ;; If there is more than one, they won't work right.
 '(package-selected-packages
   '(icomplete-vertical xclip writegood-mode wrap-region wc-mode vertico use-package synosaurus standard-themes rainbow-mode rainbow-delimiters pdf-tools pcre2el palimpsest org-wc org-static-blog org-roam-ui org-roam-bibtex org-ref org-pomodoro org-make-toc org-journal org-contrib orderless olivetti multiple-cursors move-text modus-themes markdown-mode marginalia magit lua-mode latex-preview-pane key-chord ivy helm-descbinds helm-bibtex format-all flyspell-popup expand-region engine-mode emacsql-sqlite3 elfeed-org deft backup-each-save auctex)))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
